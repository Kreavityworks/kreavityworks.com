...
void main() {
	...
	`}function hT(r){let e=new WeakMap,i=null;function s(h){if(h&&h.isTexture){const g=h.mapping,m=g===eh||g===th,v=g===Us||g===Lr;if(m||v){let x=e.get(h);const b=x!==void 0?x.texture.pmremVersion:0;if(h.isRenderTargetTexture&&h.pmremVersion!==b)return i===null&&(i=new wx(r)),x=m?i.fromEquirectangular(h,x):i.fromCubemap(h,x),x.texture.pmremVersion=h.pmremVersion,e.set(h,x),x.texture;if(x!==void 0)return x.texture;{const M=h.image;return m&&M&&M.height>0||v&&M&&l(M)?(i===null&&(i=new wx(r)),x=m?i.fromEquirectangular(h):i.fromCubemap(h),x.texture.pmremVersion=h.pmremVersion,e.set(h,x),h.addEventListener("dispose",c),x.texture):null}}}return h}function l(h){let g=0;const m=6;for(let v=0;v<m;v++)h[v]!==void 0&&g++;return g===m}function c(h){const g=h.target;g.removeEventListener("dispose",c);const m=e.get(g);m!==void 0&&(e.delete(g),m.dispose())}function d(){e=new WeakMap,i!==null&&(i.dispose(),i=null)}return{get:s,dispose:d}}function pT(r){const e={};function i(s){if(e[s]!==void 0)return e[s];const l=r.getExtension(s);return e[s]=l,l}return{has:function(s){return i(s)!==null},init:function(){i("EXT_color_buffer_float"),i("WEBGL_clip_cull_distance"),i("OES_texture_float_linear"),i("EXT_color_buffer_half_float"),i("WEBGL_multisampled_render_to_texture"),i("WEBGL_render_shared_exponent")},get:function(s){const l=i(s);return l===null&&qo("WebGLRenderer: "+s+" extension not supported."),l}}}function mT(r,e,i,s){const l={},c=new WeakMap;function d(x){const b=x.target;b.index!==null&&e.remove(b.index);for(const A in b.attributes)e.remove(b.attributes[A]);b.removeEventListener("dispose",d),delete l[b.id];const M=c.get(b);M&&(e.remove(M),c.delete(b)),s.releaseStatesOfGeometry(b),b.isInstancedBufferGeometry===!0&&delete b._maxInstanceCount,i.memory.geometries--}function h(x,b){return l[b.id]===!0||(b.addEventListener("dispose",d),l[b.id]=!0,i.memory.geometries++),b}function g(x){const b=x.attributes;for(const M in b)e.update(b[M],r.ARRAY_BUFFER)}function m(x){const b=[],M=x.index,A=x.attributes.position;let T=0;if(M!==null){const U=M.array;T=M.version;for(let D=0,P=U.length;D<P;D+=3){const I=U[D+0],F=U[D+1],z=U[D+2];b.push(I,F,F,z,z,I)}}else if(A!==void 0){const U=A.array;T=A.version;for(let D=0,P=U.length/3-1;D<P;D+=3){const I=D+0,F=D+1,z=D+2;b.push(I,F,F,z,z,I)}}else return;const S=new(gv(b)?Sv:bv)(b,1);S.version=T;const _=c.get(x);_&&e.remove(_),c.set(x,S)}function v(x){const b=c.get(x);if(b){const M=x.index;M!==null&&b.version<M.version&&m(x)}else m(x);return c.get(x)}return{get:h,update:g,getWireframeAttribute:v}}function gT(r,e,i){let s;function l(b){s=b}let c,d;function h(b){c=b.type,d=b.bytesPerElement}function g(b,M){r.drawElements(s,M,c,b*d),i.update(M,s,1)}function m(b,M,A){A!==0&&(r.drawElementsInstanced(s,M,c,b*d,A),i.update(M,s,A))}function v(b,M,A){if(A===0)return;e.get("WEBGL_multi_draw").multiDrawElementsWEBGL(s,M,0,c,b,0,A);let S=0;for(let _=0;_<A;_++)S+=M[_];i.update(S,s,1)}function x(b,M,A,T){if(A===0)return;const S=e.get("WEBGL_multi_draw");if(S===null)for(let _=0;_<b.length;_++)m(b[_]/d,M[_],T[_]);else{S.multiDrawElementsInstancedWEBGL(s,M,0,c,b,0,T,0,A);let _=0;for(let U=0;U<A;U++)_+=M[U]*T[U];i.update(_,s,1)}}this.setMode=l,this.setIndex=h,this.render=g,this.renderInstances=m,this.renderMultiDraw=v,this.renderMultiDrawInstances=x}function xT(r){const e={geometries:0,textures:0},i={frame:0,calls:0,triangles:0,points:0,lines:0};function s(c,d,h){switch(i.calls++,d){case r.TRIANGLES:i.triangles+=h*(c/3);break;case r.LINES:i.lines+=h*(c/2);break;case r.LINE_STRIP:i.lines+=h*(c-1);break;case r.LINE_LOOP:i.lines+=h*c;break;case r.POINTS:i.points+=h*c;break;default:Rt("WebGLInfo: Unknown draw mode:",d);break}}function l(){i.calls=0,i.triangles=0,i.points=0,i.lines=0}return{memory:e,render:i,programs:null,autoReset:!0,reset:l,update:s}}function vT(r,e,i){const s=new WeakMap,l=new an;function c(d,h,g){const m=d.morphTargetInfluences,v=h.morphAttributes.position||h.morphAttributes.normal||h.morphAttributes.color,x=v!==void 0?v.length:0;let b=s.get(h);if(b===void 0||b.count!==x){let N=function(){Z.dispose(),s.delete(h),h.removeEventListener("dispose",N)};var M=N;b!==void 0&&b.texture.dispose();const A=h.morphAttributes.position!==void 0,T=h.morphAttributes.normal!==void 0,S=h.morphAttributes.color!==void 0,_=h.morphAttributes.position||[],U=h.morphAttributes.normal||[],D=h.morphAttributes.color||[];let P=0;A===!0&&(P=1),T===!0&&(P=2),S===!0&&(P=3);let I=h.attributes.position.count*P,F=1;I>e.maxTextureSize&&(F=Math.ceil(I/e.maxTextureSize),I=e.maxTextureSize);const z=new Float32Array(I*F*4*x),Z=new xv(z,I,F,x);Z.type=Bi,Z.needsUpdate=!0;const w=P*4;for(let H=0;H<x;H++){const ie=_[H],ae=U[H],he=D[H],oe=I*F*4*H;for(let B=0;B<ie.count;B++){const k=B*w;A===!0&&(l.fromBufferAttribute(ie,B),z[oe+k+0]=l.x,z[oe+k+1]=l.y,z[oe+k+2]=l.z,z[oe+k+3]=0),T===!0&&(l.fromBufferAttribute(ae,B),z[oe+k+4]=l.x,z[oe+k+5]=l.y,z[oe+k+6]=l.z,z[oe+k+7]=0),S===!0&&(l.fromBufferAttribute(he,B),z[oe+k+8]=l.x,z[oe+k+9]=l.y,z[oe+k+10]=l.z,z[oe+k+11]=he.itemSize===4?l.w:1)}}b={count:x,texture:Z,size:new Ct(I,F)},s.set(h,b),h.addEventListener("dispose",N)}if(d.isInstancedMesh===!0&&d.morphTexture!==null)g.getUniforms().setValue(r,"morphTexture",d.morphTexture,i);else{let A=0;for(let S=0;S<m.length;S++)A+=m[S];const T=h.morphTargetsRelative?1:1-A;g.getUniforms().setValue(r,"morphTargetBaseInfluence",T),g.getUniforms().setValue(r,"morphTargetInfluences",m)}g.getUniforms().setValue(r,"morphTargetsTexture",b.texture,i),g.getUniforms().setValue(r,"morphTargetsTextureSize",b.size)}return{update:c}}function _T(r,e,i,s){let l=new WeakMap;function c(g){const m=s.render.frame,v=g.geometry,x=e.get(g,v);if(l.get(x)!==m&&(e.update(x),l.set(x,m)),g.isInstancedMesh&&(g.hasEventListener("dispose",h)===!1&&g.addEventListener("dispose",h),l.get(g)!==m&&(i.update(g.instanceMatrix,r.ARRAY_BUFFER),g.instanceColor!==null&&i.update(g.instanceColor,r.ARRAY_BUFFER),l.set(g,m))),g.isSkinnedMesh){const b=g.skeleton;l.get(b)!==m&&(b.update(),l.set(b,m))}return x}function d(){l=new WeakMap}function h(g){const m=g.target;m.removeEventListener("dispose",h),i.remove(m.instanceMatrix),m.instanceColor!==null&&i.remove(m.instanceColor)}return{update:c,dispose:d}}const yT={[ev]:"LINEAR_TONE_MAPPING",[tv]:"REINHARD_TONE_MAPPING",[nv]:"CINEON_TONE_MAPPING",[iv]:"ACES_FILMIC_TONE_MAPPING",[sv]:"AGX_TONE_MAPPING",[rv]:"NEUTRAL_TONE_MAPPING",[av]:"CUSTOM_TONE_MAPPING"};function bT(r,e,i,s,l){const c=new ji(e,i,{type:r,depthBuffer:s,stencilBuffer:l}),d=new ji(e,i,{type:_a,depthBuffer:!1,stencilBuffer:!1}),h=new xi;h.setAttribute("position",new Fn([-1,3,0,-1,-1,0,3,-1,0],3)),h.setAttribute("uv",new Fn([0,2,0,0,2,0],2));const g=new f1({uniforms:{tDiffuse:{value:null}},vertexShader:`
			precision highp float;
