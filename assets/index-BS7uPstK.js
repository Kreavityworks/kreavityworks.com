...
void main() {
	...
	#include <fog_fragment>
		...
		`,blending:ga,depthTest:!1,depthWrite:!1})}function eT(o,t,i){const s=new Float32Array(Rs),l=new $(0,1,0);return new ji({name:"SphericalGaussianBlur",defines:{n:Rs,CUBEUV_TEXEL_WIDTH:1/t,CUBEUV_TEXEL_HEIGHT:1/i,CUBEUV_MAX_MIP:`${o}.0`},uniforms:{envMap:{value:null},samples:{value:1},weights:{value:s},latitudinal:{value:!1},dTheta:{value:0},mipInt:{value:0},poleAxis:{value:l}},vertexShader:Yc(),fragmentShader:`
		...
		`,blending:ga,depthTest:!1,depthWrite:!1})}function Ex(){return new ji({name:"EquirectangularToCubeUV",uniforms:{envMap:{value:null}},vertexShader:Yc(),fragmentShader:`
		...
		`,blending:ga,depthTest:!1,depthWrite:!1})}function Tx(){return new ji({name:"CubemapToCubeUV",uniforms:{envMap:{value:null},flipEnvMap:{value:-1}},vertexShader:Yc(),fragmentShader:`
	...
	`}function tT(o){let t=new WeakMap,i=null;function s(h){if(h&&h.isTexture){const m=h.mapping,p=m===Zd||m===Kd,v=m===Ds||m===Ur;if(p||v){let x=t.get(h);const b=x!==void 0?x.texture.pmremVersion:0;if(h.isRenderTargetTexture&&h.pmremVersion!==b)return i===null&&(i=new Sx(o)),x=p?i.fromEquirectangular(h,x):i.fromCubemap(h,x),x.texture.pmremVersion=h.pmremVersion,t.set(h,x),x.texture;if(x!==void 0)return x.texture;{const M=h.image;return p&&M&&M.height>0||v&&M&&l(M)?(i===null&&(i=new Sx(o)),x=p?i.fromEquirectangular(h):i.fromCubemap(h),x.texture.pmremVersion=h.pmremVersion,t.set(h,x),h.addEventListener("dispose",c),x.texture):null}}}return h}function l(h){let m=0;const p=6;for(let v=0;v<p;v++)h[v]!==void 0&&m++;return m===p}function c(h){const m=h.target;m.removeEventListener("dispose",c);const p=t.get(m);p!==void 0&&(t.delete(m),p.dispose())}function d(){t=new WeakMap,i!==null&&(i.dispose(),i=null)}return{get:s,dispose:d}}function nT(o){const t={};function i(s){if(t[s]!==void 0)return t[s];const l=o.getExtension(s);return t[s]=l,l}return{has:function(s){return i(s)!==null},init:function(){i("EXT_color_buffer_float"),i("WEBGL_clip_cull_distance"),i("OES_texture_float_linear"),i("EXT_color_buffer_half_float"),i("WEBGL_multisampled_render_to_texture"),i("WEBGL_render_shared_exponent")},get:function(s){const l=i(s);return l===null&&Wo("WebGLRenderer: "+s+" extension not supported."),l}}}function iT(o,t,i,s){const l={},c=new WeakMap;function d(x){const b=x.target;b.index!==null&&t.remove(b.index);for(const A in b.attributes)t.remove(b.attributes[A]);b.removeEventListener("dispose",d),delete l[b.id];const M=c.get(b);M&&(t.remove(M),c.delete(b)),s.releaseStatesOfGeometry(b),b.isInstancedBufferGeometry===!0&&delete b._maxInstanceCount,i.memory.geometries--}function h(x,b){return l[b.id]===!0||(b.addEventListener("dispose",d),l[b.id]=!0,i.memory.geometries++),b}function m(x){const b=x.attributes;for(const M in b)t.update(b[M],o.ARRAY_BUFFER)}function p(x){const b=[],M=x.index,A=x.attributes.position;let T=0;if(M!==null){const U=M.array;T=M.version;for(let D=0,P=U.length;D<P;D+=3){const I=U[D+0],F=U[D+1],z=U[D+2];b.push(I,F,F,z,z,I)}}else if(A!==void 0){const U=A.array;T=A.version;for(let D=0,P=U.length/3-1;D<P;D+=3){const I=D+0,F=D+1,z=D+2;b.push(I,F,F,z,z,I)}}else return;const S=new(dv(b)?vv:xv)(b,1);S.version=T;const _=c.get(x);_&&t.remove(_),c.set(x,S)}function v(x){const b=c.get(x);if(b){const M=x.index;M!==null&&b.version<M.version&&p(x)}else p(x);return c.get(x)}return{get:h,update:m,getWireframeAttribute:v}}function aT(o,t,i){let s;function l(b){s=b}let c,d;function h(b){c=b.type,d=b.bytesPerElement}function m(b,M){o.drawElements(s,M,c,b*d),i.update(M,s,1)}function p(b,M,A){A!==0&&(o.drawElementsInstanced(s,M,c,b*d,A),i.update(M,s,A))}function v(b,M,A){if(A===0)return;t.get("WEBGL_multi_draw").multiDrawElementsWEBGL(s,M,0,c,b,0,A);let S=0;for(let _=0;_<A;_++)S+=M[_];i.update(S,s,1)}function x(b,M,A,T){if(A===0)return;const S=t.get("WEBGL_multi_draw");if(S===null)for(let _=0;_<b.length;_++)p(b[_]/d,M[_],T[_]);else{S.multiDrawElementsInstancedWEBGL(s,M,0,c,b,0,T,0,A);let _=0;for(let U=0;U<A;U++)_+=M[U]*T[U];i.update(_,s,1)}}this.setMode=l,this.setIndex=h,this.render=m,this.renderInstances=p,this.renderMultiDraw=v,this.renderMultiDrawInstances=x}function sT(o){const t={geometries:0,textures:0},i={frame:0,calls:0,triangles:0,points:0,lines:0};function s(c,d,h){switch(i.calls++,d){case o.TRIANGLES:i.triangles+=h*(c/3);break;case o.LINES:i.lines+=h*(c/2);break;case o.LINE_STRIP:i.lines+=h*(c-1);break;case o.LINE_LOOP:i.lines+=h*c;break;case o.POINTS:i.points+=h*c;break;default:Rt("WebGLInfo: Unknown draw mode:",d);break}}function l(){i.calls=0,i.triangles=0,i.points=0,i.lines=0}return{memory:t,render:i,programs:null,autoReset:!0,reset:l,update:s}}function rT(o,t,i){const s=new WeakMap,l=new an;function c(d,h,m){const p=d.morphTargetInfluences,v=h.morphAttributes.position||h.morphAttributes.normal||h.morphAttributes.color,x=v!==void 0?v.length:0;let b=s.get(h);if(b===void 0||b.count!==x){let N=function(){Z.dispose(),s.delete(h),h.removeEventListener("dispose",N)};var M=N;b!==void 0&&b.texture.dispose();const A=h.morphAttributes.position!==void 0,T=h.morphAttributes.normal!==void 0,S=h.morphAttributes.color!==void 0,_=h.morphAttributes.position||[],U=h.morphAttributes.normal||[],D=h.morphAttributes.color||[];let P=0;A===!0&&(P=1),T===!0&&(P=2),S===!0&&(P=3);let I=h.attributes.position.count*P,F=1;I>t.maxTextureSize&&(F=Math.ceil(I/t.maxTextureSize),I=t.maxTextureSize);const z=new Float32Array(I*F*4*x),Z=new hv(z,I,F,x);Z.type=Ii,Z.needsUpdate=!0;const w=P*4;for(let V=0;V<x;V++){const ie=_[V],ae=U[V],he=D[V],oe=I*F*4*V;for(let B=0;B<ie.count;B++){const k=B*w;A===!0&&(l.fromBufferAttribute(ie,B),z[oe+k+0]=l.x,z[oe+k+1]=l.y,z[oe+k+2]=l.z,z[oe+k+3]=0),T===!0&&(l.fromBufferAttribute(ae,B),z[oe+k+4]=l.x,z[oe+k+5]=l.y,z[oe+k+6]=l.z,z[oe+k+7]=0),S===!0&&(l.fromBufferAttribute(he,B),z[oe+k+8]=l.x,z[oe+k+9]=l.y,z[oe+k+10]=l.z,z[oe+k+11]=he.itemSize===4?l.w:1)}}b={count:x,texture:Z,size:new Ct(I,F)},s.set(h,b),h.addEventListener("dispose",N)}if(d.isInstancedMesh===!0&&d.morphTexture!==null)m.getUniforms().setValue(o,"morphTexture",d.morphTexture,i);else{let A=0;for(let S=0;S<p.length;S++)A+=p[S];const T=h.morphTargetsRelative?1:1-A;m.getUniforms().setValue(o,"morphTargetBaseInfluence",T),m.getUniforms().setValue(o,"morphTargetInfluences",p)}m.getUniforms().setValue(o,"morphTargetsTexture",b.texture,i),m.getUniforms().setValue(o,"morphTargetsTextureSize",b.size)}return{update:c}}function oT(o,t,i,s){let l=new WeakMap;function c(m){const p=s.render.frame,v=m.geometry,x=t.get(m,v);if(l.get(x)!==p&&(t.update(x),l.set(x,p)),m.isInstancedMesh&&(m.hasEventListener("dispose",h)===!1&&m.addEventListener("dispose",h),l.get(m)!==p&&(i.update(m.instanceMatrix,o.ARRAY_BUFFER),m.instanceColor!==null&&i.update(m.instanceColor,o.ARRAY_BUFFER),l.set(m,p))),m.isSkinnedMesh){const b=m.skeleton;l.get(b)!==p&&(b.update(),l.set(b,p))}return x}function d(){l=new WeakMap}function h(m){const p=m.target;p.removeEventListener("dispose",h),i.remove(p.instanceMatrix),p.instanceColor!==null&&i.remove(p.instanceColor)}return{update:c,dispose:d}}const lT={[Kx]:"LINEAR_TONE_MAPPING",[Qx]:"REINHARD_TONE_MAPPING",[Jx]:"CINEON_TONE_MAPPING",[$x]:"ACES_FILMIC_TONE_MAPPING",[tv]:"AGX_TONE_MAPPING",[nv]:"NEUTRAL_TONE_MAPPING",[ev]:"CUSTOM_TONE_MAPPING"};function cT(o,t,i,s,l){const c=new ki(t,i,{type:o,depthBuffer:s,stencilBuffer:l}),d=new ki(t,i,{type:_a,depthBuffer:!1,stencilBuffer:!1}),h=new xi;h.setAttribute("position",new Fn([-1,3,0,-1,-1,0,3,-1,0],3)),h.setAttribute("uv",new Fn([0,2,0,0,2,0],2));const m=new $S({uniforms:{tDiffuse:{value:null}},vertexShader:`
			precision highp float;
